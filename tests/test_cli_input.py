...
from prj3bot.cli import commands
...
def mock_prompt_session():
    ...
    with patch("prj3bot.cli.commands._PROMPT_SESSION", mock_session), \
         patch("prj3bot.cli.commands.patch_stdout"):
        yield mock_session
...
def test_init_prompt_session_creates_session():
    ...
    with patch("prj3bot.cli.commands.PromptSession") as MockSession, \
         patch("prj3bot.cli.commands.FileHistory") as MockHistory, \
