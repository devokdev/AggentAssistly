...
try:
    ...
    raise ImportError(
        "Matrix dependencies not installed. Run: pip install prj3bot-ai[matrix]"
    ) from e

from prj3bot.bus.events import OutboundMessage
from prj3bot.channels.base import BaseChannel
from prj3bot.config.loader import get_data_dir
from prj3bot.utils.helpers import safe_filename
